...
const ConvertToBlooming = ({
  ...
  const handleRfidScan = async () => {
    ...
    try {
      console.log(`🚀 Starte RFID-Scan für Konvertierung zu Blühpflanzen mit Device ID: ${deviceId} (Raum: ${selectedRoom.name})...`);
      ...
      setTimeout(async () => {
        ...
        console.log("Convert form data mit RFID member_id:", formData);
  ...
  const isFormValid = () => {
    return quantity > 0 && quantity <= maxQuantity && roomId;
  };
    ...
    >
            ...
            <Fade in={scanSuccess}>
              <Box sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="body1" align="center" color="white" sx={{ mt: 2 }}>
                  {quantity} {quantity > 1 ? 'Blühpflanzen wurden' : 'Blühpflanze wurde'} aus Stecklingen erstellt
                </Typography>
      ...
      <DialogContent>
        ...
        <TextField
          ...
          required
          helperText={`Maximal ${maxQuantity} Blühpflanzen möglich`}
        />
      ...
      <DialogActions>
        ...
        <Button 
          ...
          startIcon={loading ? <CircularProgress size={16} /> : <LocalFloristIcon />}
          sx={{ minWidth: 200 }}
        >
